...
/**
 * Extracts file name information from  a {@link WilmaHttpRequest} and creates an
 * {@link IndexMessage} that will be sent to a {@link JmsMessageIndexer}.
 * @author Tunde_Kovacs
 *
 */
@Component
public class JmsRequestIndexingProcessor {
     ...
     */
    public void process(final WilmaHttpRequest request) {
        String fileName = fileNameProvider.getFileName(request);
