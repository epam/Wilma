...
/**
 * Provides unit tests for the class {@link com.epam.wilma.webapp.config.servlet.stub.upload.ExternalInterceptorUploadServletTest}.
 * @author Tamas Kohegyi
 *
 */
public class ExternalInterceptorUploadServletTest {
    ...
    @InjectMocks
    private ExternalInterceptorUploadServlet underTest;
    ...
    public void testDoGetWhenFileNameIsNullShouldWriteErrorToResponse() throws ServletException, IOException {
        ...
        underTest.doGet(request, response);
        //THEN
        verify(printWriter).write("Please give a name to the interceptor! e.g.:.../interceptor?fileName=ExternalInterceptor.class");
    }
