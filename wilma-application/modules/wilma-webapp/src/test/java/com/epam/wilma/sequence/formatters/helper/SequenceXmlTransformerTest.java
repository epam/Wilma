...
public class SequenceXmlTransformerTest {
    ...
    @InjectMocks
    private SequenceXmlTransformer underTest;
    ...
    public void testCreateMapShouldStoreEntityBodyByResolvedName() {
        ...
        given(messageFactory.createSoapMessage(wilmaHttpRequest, nullConverter)).willReturn(messageRequest);
        given(messageFactory.createSoapMessage(wilmaHttpResponse, nullConverter)).willReturn(messageResponse);
    ...
    public void testCreateMapShouldCreateSoapMessageFromSoapTypeEntity() {
        ...
        //THEN
        verify(messageFactory).createSoapMessage(wilmaHttpRequest, nullConverter);
        verify(messageFactory).createSoapMessage(wilmaHttpResponse, nullConverter);
    }
    ...
    public void testCreateMapShouldCreateRestMessageFromJsonTypeEntity() {
        ...
        given(messageFactory.createRestRequest(wilmaHttpRequest, jsonConverter)).willReturn(messageRequest);
        given(messageFactory.createRestResponse(wilmaHttpResponse, jsonConverter, wilmaHttpRequest)).willReturn(messageResponse);
        given(messageRequest.resolveName(parameterList)).willReturn("kalap");
        given(messageResponse.resolveName(parameterList)).willReturn("kabat");
        //WHEN
        underTest.transform(parameterList, messages);
        //THEN
        verify(messageFactory).createRestRequest(wilmaHttpRequest, jsonConverter);
        verify(messageFactory).createRestResponse(wilmaHttpResponse, jsonConverter, wilmaHttpRequest);
    }
