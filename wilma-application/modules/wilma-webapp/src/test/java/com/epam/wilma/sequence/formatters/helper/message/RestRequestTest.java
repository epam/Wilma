...
public class RestRequestTest {
    ...
    public void testResolveNameShouldReturnResolvedNameWithPostfix() {
        //GIVEN
        given(restUrlMappingMessageNameResolver.resolve(entity, parameters)).willReturn("name");
        //WHEN
    ...
    public void testResolveNameShouldReturnEmptyStringWhenResolvedNameIsEmpty() {
        //GIVEN
        given(restUrlMappingMessageNameResolver.resolve(entity, parameters)).willReturn("");
        //WHEN
        String result = underTest.resolveName(parameters);
        //THEN
        String expected = "";
