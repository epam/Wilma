...
/**
 * Provides unit tests for the class {@link ExternalConditionCheckerUploadServletTest}.
 * @author Tunde_Kovacs
 *
 */
public class ExternalConditionCheckerUploadServletTest {
    ...
    public void testDoGetWhenFileNameIsNullShouldWriteErrorToResponse() throws ServletException, IOException {
        ...
        underTest.doGet(request, response);
        //THEN
        verify(printWriter).write("Please give a name to the condition checker! e.g.:.../conditionchecker?fileName=ExternalConditionChecker.class");
    }
