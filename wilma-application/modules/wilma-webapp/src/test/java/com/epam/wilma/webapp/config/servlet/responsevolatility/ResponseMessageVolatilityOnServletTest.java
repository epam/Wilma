...
/**
 * Test class for {@link ResponseMessageVolatilityOnServlet}.
 *
 * @author Tamas_Kohegyi
 */
public class ResponseMessageVolatilityOnServletTest {

    @InjectMocks
    private ResponseMessageVolatilityOnServlet underTest;
