 ...
 *
 */
public class SequenceHandlingOffServletTest {
    private static final String MESSAGE = "Sequence handling: OFF";
    ...
    @InjectMocks
    private SequenceHandlingOffServlet underTest;
    ...
    public void testDoGetShouldSwitchSequenceHandlingOff() throws ServletException, IOException {
        ...
        //THEN
        verify(sequenceHandlingToggle).switchOff();
    }
