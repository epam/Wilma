 ...
 */
@Component
public class NewStubDescriptorJsonCommandFactory {
     ...
     */
    public StubDescriptorModificationCommand create(final String filePath, final StubDescriptorJsonFactory stubConfigurationBuilder,
