...
public class NewStubDescriptorCommandFactory {
     ...
     */
    public StubDescriptorModificationCommand create(final String filePath, final StubDescriptorFactory stubConfigurationBuilder,
        ...
        return create(inputStream, stubConfigurationBuilder, sequenceDescriptorHolder);
    }
     ...
     * @return the new instance
     */
    public StubDescriptorModificationCommand create(final InputStream inputStream, final StubDescriptorFactory stubConfigurationBuilder,
            final SequenceDescriptorHolder sequenceDescriptorHolder) {
        return new NewStubDescriptorCommand(inputStream, stubConfigurationBuilder, sequenceDescriptorHolder);
    }
}
