 ...
 */
@Component
public class ResponseMessageVolatilityStatusServlet extends HttpServlet {

    private final Logger logger = LoggerFactory.getLogger(ResponseMessageVolatilityStatusServlet.class);
