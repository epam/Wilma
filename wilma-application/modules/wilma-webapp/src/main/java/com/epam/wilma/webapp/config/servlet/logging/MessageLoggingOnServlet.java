 ...
 */
@Component
public class MessageLoggingOnServlet extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
        logger.info(urlAccessLogMessageAssembler.assembleMessage(req, "Message logging: ON"));
        messageLoggingToggle.switchOnMessageLogging();
    }
