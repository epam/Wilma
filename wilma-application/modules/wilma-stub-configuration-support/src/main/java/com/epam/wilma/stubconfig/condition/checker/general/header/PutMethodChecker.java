...
/**
 * Checks if the request method is PUT or not.
 *
 * @author Tamas_Kohegyi
 */
public class PutMethodChecker extends MethodCheckOperator implements ConditionChecker {

    @Override
    public boolean checkCondition(final WilmaHttpRequest request, final ParameterList parameterList) {
        return isExpectedMethod(MethodEnum.PUT, request.getRequestLine());
    }
