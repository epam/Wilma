...
/**
 * Checks if the request method is OPTIONS or not.
 *
 * @author Tamas_Kohegyi
 */
public class OptionsMethodChecker extends MethodCheckOperator implements ConditionChecker {

    @Override
    public boolean checkCondition(final WilmaHttpRequest request, final ParameterList parameterList) {
        return isExpectedMethod(MethodEnum.OPTIONS, request.getRequestLine());
    }
