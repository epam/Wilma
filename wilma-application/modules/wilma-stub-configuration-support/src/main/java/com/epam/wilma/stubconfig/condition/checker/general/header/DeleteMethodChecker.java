...
/**
 * Checks if the request method is DELETE or not.
 *
 * @author Tamas_Kohegyi
 */
public class DeleteMethodChecker extends MethodCheckOperator implements ConditionChecker {

    @Override
    public boolean checkCondition(final WilmaHttpRequest request, final ParameterList parameterList) {
        return isExpectedMethod(MethodEnum.DELETE, request.getRequestLine());
    }
