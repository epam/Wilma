...
/**
 * Tests for {@link HeadMethodChecker}.
 *
 * @author Tamas_Kohegyi
 */
public class HeadMethodCheckerTest {
    ...
    private HeadMethodChecker underTest;

    @BeforeMethod
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        underTest = new HeadMethodChecker();
    ...
    public void testCheckConditionShouldReturnTrueWhenRequestWhatWeExpect() {
        ...
        given(request.getRequestLine()).willReturn("HEAD BLAH");
        //WHEN
