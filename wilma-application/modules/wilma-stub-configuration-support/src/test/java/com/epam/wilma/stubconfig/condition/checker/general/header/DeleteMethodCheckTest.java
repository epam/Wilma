...
/**
 * Tests for {@link DeleteMethodChecker}.
 *
 * @author Tamas_Kohegyi
 */
public class DeleteMethodCheckTest {
    ...
    private DeleteMethodChecker underTest;

    @BeforeMethod
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        underTest = new DeleteMethodChecker();
    ...
    public void testCheckConditionShouldReturnTrueWhenRequestWhatWeExpect() {
        ...
        given(request.getRequestLine()).willReturn("DELETE BLAH");
        //WHEN
