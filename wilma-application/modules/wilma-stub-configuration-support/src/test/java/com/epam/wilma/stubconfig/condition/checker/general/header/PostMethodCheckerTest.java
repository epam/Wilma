...
/**
 * Tests for {@link PostMethodChecker}.
 *
 * @author Tamas_Kohegyi
 */
public class PostMethodCheckerTest {
    ...
    private PostMethodChecker underTest;

    @BeforeMethod
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        underTest = new PostMethodChecker();
    ...
    public void testCheckConditionShouldReturnTrueWhenRequestWhatWeExpect() {
        ...
        given(request.getRequestLine()).willReturn("POST BLAH");
        //WHEN
