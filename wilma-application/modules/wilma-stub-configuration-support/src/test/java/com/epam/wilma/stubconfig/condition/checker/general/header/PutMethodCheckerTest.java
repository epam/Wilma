...
/**
 * Tests for {@link PutMethodChecker}.
 *
 * @author Tamas_Kohegyi
 */
public class PutMethodCheckerTest {
    ...
    private PutMethodChecker underTest;

    @BeforeMethod
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        underTest = new PutMethodChecker();
    ...
    public void testCheckConditionShouldReturnTrueWhenRequestWhatWeExpect() {
        ...
        given(request.getRequestLine()).willReturn("PUT BLAH");
        //WHEN
