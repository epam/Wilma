...
/**
 * Provides unit tests for the <tt>BrowserMobHttpRequestTransformer</tt> class.
 *
 * @author Tunde_Kovacs
 */
public class BrowserMobHttpRequestTransformerTest {
    ...
    @InjectMocks
    private BrowserMobHttpRequestTransformer underTest;
