 ...
 * <p/>
 * First sends two XML request gets two XML responses after that sends a JSON request and expects that
 * the JSON response to the JSON request contains a value from the first XML response and the second XML response.
 *
 * @author Adam_Csaba_Kiraly
 */
@TestClass(id = "SequenceHandling", name = "Session XML to JSON formatting")
public class SequenceHandlingTestXmlToJson extends SequenceHandlingTestBase {

    private static final String ORIGINAL_REQUEST = "resources/sequence/live/jsonrequests/OriginalRequest.xml";
    private static final String JSON_REQUEST = "resources/sequence/live/jsonrequests/JsonRequest.json";
    private static final String MAGIC_REQUEST = "resources/sequence/live/jsonrequests/MagicRequest.xml";
    private static final String EXPECTED_RESPONSE = "{\"my_favorite_string\":\"false\",\"links\":\"false\"}";
    private static final String STUB_CONFIG_LOCATION = "resources/sequence/live/stubConfigXmlToJson.json";
    ...
    public void testSessionBasedSequence() throws Exception {
        ...
        Collection<File> templateFiles = FileUtils.listFiles(new File("resources/sequence/live/jsontemplates"), new String[]{"xml", "xsl", "json"},
                false);
