...
/**
 * This class upload two new stub configurations then set disabled to the first configuration and checks if the second will answer.
 * @author Tibor_Kovacs
 *
 */
@TestClass(id = "Multi_StubConfig", name = "First is disabled so the second will answer")
public class FirstDisabledSecondEnabledTest extends MultiStubConfigTestBase {
