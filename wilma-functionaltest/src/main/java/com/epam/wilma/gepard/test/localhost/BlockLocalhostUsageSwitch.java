 ...
 *
 */
public class BlockLocalhostUsageSwitch {

    private static final int STATUS_OK = 200;
    private static final String URL_TEMPLATE = "%sconfig/admin/localhost/%s";

    /**
     * Set localhost blocking to on/off.
     *
     ...
     */
    public String setLocalhostBlockingModeTo(final WilmaTestLogDecorator tc, final String host, final String state) throws Exception {
