...
public class MailingListIssuesTest extends DummyServerTest {
    private static final String JSONRPC_URL = BASE_URL + "/jsonrpc/";
    private static final String ENCODED_QUERY_STRING_URL = BASE_URL + "/a.txt?foo=bar&a=1%262";
    private static final String C_PNG_URL = BASE_URL + "/c.png";
    private static final String B_TXT_URL = BASE_URL + "/b.txt";
    ...
    public void testThatInterceptorIsCalled() throws IOException, InterruptedException {
        ...
        String body = IOUtils.readFully(client.execute(new HttpGet(A_TXT_URL)).getEntity().getContent());
    ...
    public void testThatProxyCanCaptureJsonRpc() throws IOException, InterruptedException {
        ...
        HttpPost post = new HttpPost(JSONRPC_URL);
    ...
    public void testThatImagesAreCapturedAsBase64EncodedContent() throws IOException, InterruptedException {
        ...
        InputStream is1 = client.execute(new HttpGet(C_PNG_URL)).getEntity().getContent();
